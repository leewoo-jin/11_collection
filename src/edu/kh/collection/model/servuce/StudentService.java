...
public class StudentService {
	...
	//ArrayList(용랑): 용량만큼의 리스트 생성
	//             -> 너무 큰값을 작성하면 메모리를 많이 소모함.
	
	//private List<Student> studentList = new ArrayList<Student>(); // 검색(조회)에 효울적
	...
	public StudentService() {
		...
		studentList.add(new Student("고길동",25,"서울시 강남구",'M',80));
	...
	public void ex() {
		...
		studentList.add(new Student()); // 0번쨰 인덱스
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("6. 이름으로 갬색(포함)");
	...
	public String updateStudent()throws InputMismatchException {
		...
		// -> 반환값 Student == 변경전 Student 객체가 담겨있다.
		...
		// 4) 입력받은 숫자가syudentList 범위 내 인덱스 번호인가?
	...
	//0번 : Student [name=고영희, age=23, region=경기도 안산, gender=F, score=100]
